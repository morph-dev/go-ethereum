...
type Config struct {
	...
	FrameTxValidation       bool // EIP-8141: Disables certain opcodes during frame tx mempool validation
	FrameTxValidationPrefix uint // EIP-8141: Number of frames used for frame tx mempool validation
}
